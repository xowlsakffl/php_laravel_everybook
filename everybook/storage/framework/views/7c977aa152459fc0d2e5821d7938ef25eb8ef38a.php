            ...
            <div class="p-3 flex items-center gap-4">
                <?php if(auth()->guard()->check()): ?>
                        <?php if($post->checkLike(auth()->user())): ?>
                            <form action="<?php echo e(route('posts.likes.destroy', $post)); ?>" method="POST">
                        ...
                        <?php else: ?>
                            <form action="<?php echo e(route('posts.likes.store', $post)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="my-4">
                                    <button type="submit">
                        ...
                        <?php endif; ?>
                <?php endif; ?>
                <p class="font-bold"><?php echo e($post->likes->count()); ?> <span class="font-normal">Likes</span></p>
            </div>
